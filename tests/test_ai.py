...
class TestAISuggestions:
    ...
    @patch('app.services.ai.openai_service.OpenAIService.generate_todo_suggestions')
...
class TestAIPriorityAnalysis:
    ...
    @patch('app.services.ai.openai_service.OpenAIService.analyze_todo_priority')
...
class TestAIImproveDescription:
    ...
    @patch('app.services.ai.openai_service.OpenAIService.improve_todo_description')
...
class TestAIChat:
    ...
    @patch('app.services.ai.openai_service.OpenAIService.chat_with_history')
